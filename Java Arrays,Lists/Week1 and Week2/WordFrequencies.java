...
public class WordFrequencies {
    ...
    public void tester() {
        findUnique();
        System.out.println("No of Unique Words are "+myWords.size());
        for (int i = 0; i < myWords.size(); i++)
            System.out.println(myWords.get(i) + " repeated for " + myFreqs.get(i) + " times");
        System.out.println("Index of most Frequent Word "+findIndexOfMax());
    }
