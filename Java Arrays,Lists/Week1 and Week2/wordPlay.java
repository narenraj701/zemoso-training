...
public class wordPlay {
    ...
    public String emphasize(String Phrase,Character c){
        String p="";
        for(int i=0;i<Phrase.length();i++) {
    ...
    public static void main(String[] args) {
        wordPlay c=new wordPlay();
        System.out.println(c.isVowel('p'));
        System.out.println(c.replaceVowels("Hello World",'*'));
        System.out.println(c.emphasize("dna ctgaaactga",'a'));
        System.out.println(c.emphasize("Mary Bella Abracadabra",'a'));
    }
}
